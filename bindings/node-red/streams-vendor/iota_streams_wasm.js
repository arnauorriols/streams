...
function __wbg_adapter_30(arg0, arg1, arg2) {
    wasm._dyn_core__ops__function__FnMut__A____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h1adee366a495a62c(arg0, arg1, addHeapObject(arg2));
}
...
function __wbg_adapter_225(arg0, arg1, arg2, arg3) {
    wasm.wasm_bindgen__convert__closures__invoke2_mut__h3a4627a566036311(arg0, arg1, addHeapObject(arg2), addHeapObject(arg3));
}
...
class Author {
    ...
    */
    syncState() {
        const ptr = this.__destroy_into_raw();
        var ret = wasm.author_syncState(ptr);
        return takeObject(ret);
    }
    /**
    ...
    */
    fetchNextMsgs() {
        const ptr = this.__destroy_into_raw();
        var ret = wasm.author_fetchNextMsgs(ptr);
        return takeObject(ret);
    }
    /**
    ...
    */
    fetchNextMsg() {
        const ptr = this.__destroy_into_raw();
        var ret = wasm.author_fetchNextMsg(ptr);
        return takeObject(ret);
    }
    /**
    * @param {Address} link
    ...
    */
    genNextMsgAddresses() {
        var ret = wasm.author_genNextMsgAddresses(this.ptr);
        return takeObject(ret);
    }
    /**
    * @returns {Array<any>}
...
class NextMsgAddress {
    ...
    */
    get address() {
        var ret = wasm.__wbg_get_nextmsgaddress_address(this.ptr);
        return Address.__wrap(ret);
    }
    /**
    * @param {Address} arg0
    ...
    */
    static new(identifier, address) {
        ...
        address.ptr = 0;
        var ret = wasm.nextmsgaddress_new(ptr0, len0, ptr1);
        return NextMsgAddress.__wrap(ret);
    }
}
module.exports.NextMsgAddress = NextMsgAddress;
/**
*/
class PskIds {
...
class Subscriber {
    ...
    */
    syncState() {
        const ptr = this.__destroy_into_raw();
        var ret = wasm.subscriber_syncState(ptr);
        return takeObject(ret);
    }
    /**
    * Fetch all the pending messages that the user can read and collect them into an Array
    ...
    */
    fetchNextMsgs() {
        const ptr = this.__destroy_into_raw();
        var ret = wasm.subscriber_fetchNextMsgs(ptr);
        return takeObject(ret);
    }
    /**
    * Fetch the immediately next message that the user can read
    ...
    */
    fetchNextMsg() {
        const ptr = this.__destroy_into_raw();
        var ret = wasm.subscriber_fetchNextMsg(ptr);
        return takeObject(ret);
    }
    /**
    * @param {Address} link
    ...
    */
    genNextMsgAddresses() {
        var ret = wasm.subscriber_genNextMsgAddresses(this.ptr);
        return takeObject(ret);
    }
    /**
    * @returns {Array<any>}
...
module.exports.__wbg_nextmsgaddress_new = function(arg0) {
    var ret = NextMsgAddress.__wrap(arg0);
    return addHeapObject(ret);
};
...
module.exports.__wbindgen_closure_wrapper4553 = function(arg0, arg1, arg2) {
