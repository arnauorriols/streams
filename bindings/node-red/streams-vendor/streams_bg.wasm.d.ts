...
export function addressgetter_accountIndex(a: number, b: number): number;
export function addressgetter_range(a: number, b: number, c: number): number;
export function addressgetter_bech32Hrp(a: number, b: number, c: number): number;
export function addressgetter_includeInternal(a: number): number;
export function addressgetter_get(a: number): number;
...
export function client_getInfo(a: number): number;
export function client_getNodeInfo(a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number): number;
export function client_networkInfo(a: number): number;
export function client_getNetworkId(a: number): number;
export function client_getBech32Hrp(a: number): number;
export function client_getMinPowScore(a: number): number;
export function client_getHealth(a: number): number;
export function client_getTips(a: number): number;
export function client_getPeers(a: number): number;
export function client_getOutput(a: number, b: number, c: number): number;
export function client_findMessages(a: number, b: number, c: number): number;
export function client_findInputs(a: number, b: number, c: number, d: number): number;
export function client_findOutputs(a: number, b: number, c: number): number;
export function client_getAddressBalances(a: number, b: number): number;
export function client_getMilestone(a: number, b: number): number;
export function client_getMilestoneUtxoChanges(a: number, b: number): number;
export function client_getReceipts(a: number): number;
export function client_getReceiptsMigratedAt(a: number, b: number): number;
export function client_getTreasury(a: number): number;
export function client_getIncludedMessage(a: number, b: number, c: number): number;
export function client_postMessage(a: number, b: number): number;
export function client_retry(a: number, b: number, c: number): number;
export function client_retryUntilIncluded(a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number): number;
export function client_reattach(a: number, b: number, c: number): number;
export function client_promote(a: number, b: number, c: number): number;
export function client_consolidateFunds(a: number, b: number, c: number, d: number, e: number, f: number): number;
export function client_bech32ToHex(a: number, b: number, c: number, d: number): void;
export function client_hexToBech32(a: number, b: number, c: number, d: number, e: number): number;
export function client_hexPublicKeyToBech32Address(a: number, b: number, c: number, d: number, e: number): number;
...
export function getaddressbuilder_balance(a: number, b: number, c: number): number;
export function getaddressbuilder_outputs(a: number, b: number, c: number, d: number): number;
...
export function balancegetter_accountIndex(a: number, b: number): number;
export function balancegetter_initialAddressIndex(a: number, b: number): number;
export function balancegetter_gap_limit(a: number, b: number): number;
export function balancegetter_get(a: number): number;
export function __wbg_clientbuilder_free(a: number): void;
export function clientbuilder_new(): number;
export function clientbuilder_node(a: number, b: number, c: number): number;
export function clientbuilder_primaryNode(a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number): number;
export function clientbuilder_primaryPowNode(a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number): number;
export function clientbuilder_permanode(a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number): number;
export function clientbuilder_nodeAuth(a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number): number;
export function clientbuilder_nodes(a: number, b: number): number;
export function clientbuilder_nodeSyncInterval(a: number, b: number): number;
export function clientbuilder_nodeSyncDisabled(a: number): number;
export function clientbuilder_offlineMode(a: number): number;
export function clientbuilder_nodePoolUrls(a: number, b: number): number;
export function clientbuilder_quorum(a: number, b: number): number;
export function clientbuilder_quorumSize(a: number, b: number): number;
export function clientbuilder_quorumThreshold(a: number, b: number): number;
export function clientbuilder_network(a: number, b: number, c: number): number;
export function clientbuilder_localPow(a: number, b: number): number;
export function clientbuilder_tipsInterval(a: number, b: number): number;
export function clientbuilder_requestTimeout(a: number, b: number): number;
export function clientbuilder_apiTimeout(a: number, b: number, c: number, d: number): number;
export function clientbuilder_build(a: number): number;
...
export function unspentaddressgetter_accountIndex(a: number, b: number): number;
export function unspentaddressgetter_initialAddressIndex(a: number, b: number): number;
export function unspentaddressgetter_get(a: number): number;
export function __wbg_messagebuilder_free(a: number): void;
export function messagebuilder_new(a: number): number;
export function messagebuilder_index(a: number, b: number, c: number): number;
export function messagebuilder_data(a: number, b: number, c: number): number;
export function messagebuilder_seed(a: number, b: number, c: number): number;
export function messagebuilder_accountIndex(a: number, b: number): number;
export function messagebuilder_initialAddressIndex(a: number, b: number): number;
export function messagebuilder_parents(a: number, b: number): number;
export function messagebuilder_input(a: number, b: number, c: number): number;
export function messagebuilder_inputRange(a: number, b: number, c: number): number;
export function messagebuilder_output(a: number, b: number, c: number, d: number, e: number): number;
export function messagebuilder_dustAllowanceOutput(a: number, b: number, c: number, d: number, e: number): number;
export function messagebuilder_prepareTransaction(a: number): number;
export function messagebuilder_signTransaction(a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number): number;
export function messagebuilder_finishMessage(a: number, b: number): number;
export function messagebuilder_submit(a: number): number;
export function __wbg_messagegetter_free(a: number): void;
export function messagegetter_new(a: number): number;
export function messagegetter_index(a: number, b: number, c: number): number;
export function messagegetter_data(a: number, b: number, c: number): number;
export function messagegetter_raw(a: number, b: number, c: number): number;
export function messagegetter_children(a: number, b: number, c: number): number;
export function messagegetter_metadata(a: number, b: number, c: number): number;
...
export function author_reset_state(a: number): void;
...
export function _dyn_core__ops__function__FnMut__A____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h4e47cf0241406bf8(a: number, b: number, c: number): void;
export function _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__haefdc234c1cad14c(a: number, b: number): void;
export function __wbindgen_add_to_stack_pointer(a: number): number;
export function __wbindgen_free(a: number, b: number): void;
export function __wbindgen_exn_store(a: number): void;
export function wasm_bindgen__convert__closures__invoke2_mut__hdcdceade53d4ebea(a: number, b: number, c: number, d: number): void;
