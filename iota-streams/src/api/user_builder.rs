...
impl<T> UserBuilder<T> {
    ...
    /// [`BucketTransport`](iota_streams_app::transport::BucketTransport) if not)
    ///
    /// # Errors
    ...
    /// use iota_streams::{id::Ed25519, transport::tangle, User};
    ///
    /// # #[tokio::main]
    ...
    /// # use anyhow::Result;
    /// # use iota_streams::transport::bucket;
    /// use iota_streams::{id::Psk, transport::tangle, User};
    ///
    /// # #[tokio::main]
    /// # async fn main() -> Result<()> {
    /// let transport: tangle::Client = tangle::Client::for_node("https://chrysalis-nodes.iota.org").await?;
    ...
    /// let transport = tangle::Client::for_node("https://chrysalis-nodes.iota.org").await?;
    /// #
